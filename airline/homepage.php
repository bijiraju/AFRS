        ...
        <div class="row">
            <div class="col-12 col-lg-6 my-4">
                ...
                <form action="search_index.php" class="" method="POST">
                    ...
                    <div class="my-3">
                        <select class="form-select" name="ARRIVAL" aria-label="Default select example">
                    ...
                    <div class="my-3">
                        <div class="col">
                            <input class="form-control" type="date" name="DATE" id="from" placeholder="Date">
                        </div>
                    </div>
                    <button href="" class="btn btn-success my-1" type="submit" name="submit">Search</button>
                </form>
            </div>
            <div class="col-12 col-lg-6 my-4">
